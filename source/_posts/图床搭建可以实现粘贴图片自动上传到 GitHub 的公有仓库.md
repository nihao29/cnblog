---
abbrlink: ''
ai: 图床搭建可以实现粘贴图片自动上传到 GitHub 的公有仓库  使用 Obsidian 等 Markdown 编辑器时，可靠又稳定的图床是必不可少的。PicGo
...
date: '2024-11-06T14:08:23.140826+08:00'
tags:
- 图床
- 搭建图床
title: 图床搭建可以实现粘贴图片自动上传到 GitHub 的公有仓库
updated: '2024-11-06T14:09:16.386+08:00'
---
图床搭建可以实现粘贴图片自动上传到 GitHub 的公有仓库
