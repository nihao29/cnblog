...
预览: 👍 [AnZhiYu](https://blog.blog.httple.net/) || 🤞 [AnZhiYu](https://index.blog.httple.net/)

文档: 📖 [anzhiyu Docs](https://docs.blog.httple.net/)
...
- ✅ 无比详实的[用户文档](https://docs.blog.httple.net/)
- ✅ 页面组件懒加载(pjax方案)
- ✅ 图片懒加载
- ✅ 多种代码高亮方案
- ✅ 多语言配置
